...
const char* Title = "Multiple light sources";
...
int main()
{
    ...
    while (! glfwWindowShouldClose(window))
    {
        ...
        // glm::vec3 dir = glm::vec3(0.0f,0.0f,1.0f) - camera.Position;

        // float d = glm::dot(dir,glm::vec3(0,0,1));
        // view = glm::rotate(view,glm::radians(2.0f*3.14f - d),glm::vec3(0.0f,0.0f,1.0f));
