...
int main()
{
    ...
    // ------------------------------------
    // MyShader lightingShader("./res/AmbientVS.vs", "./res/AmbientFS.fs");
    // MyShader lightingShader("./res/DiffVS.vs", "./res/DiffFS.fs");
    MyShader lightingShader("./res/SpecularVS.vs", "./res/SpecularFS.fs");
    MyShader lightCubeShader("./res/whiteLighVertexShader.vs", "./res/whiteLightFragment.fs");
